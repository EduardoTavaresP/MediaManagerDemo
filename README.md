...
1. Setup MediaManagerDemo:
  ...
  * Link to your AppJs build: `cd MediaManagerDemo/; mkdir bin; pushd bin; ln -s ../../appjs-build/appjs/node-32/0.8.11/bin/node .; popd; ln -s ../appjs-build/appjs/app/data/node_modules .;`
